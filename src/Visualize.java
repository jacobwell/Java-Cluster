 ...
 * @editors Jacob Wellinghoff (jgw7654), Ian Dempsey (ijd8975)
 * 
 */
...
public class Visualize {
    ...
    public void showPoints (java.util.ArrayList <ColoredPoint> data){

        Iterator <ColoredPoint> it = data.iterator();
        while (it.hasNext()) {
